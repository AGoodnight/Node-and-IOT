...
//===============================================================
#define AWS_IOT_MQTT_HOST "A1GPTJPCIB99EW.iot.us-east-1.amazonaws.com" 	// your endpoint
#define AWS_IOT_MQTT_PORT 8883									// your port
#define AWS_IOT_CLIENT_ID	"DerekYun"						// your client ID
#define AWS_IOT_MY_THING_NAME "DerekYun"						// your thing name
#define AWS_IOT_ROOT_CA_FILENAME "root-CA.crt"           // your root-CA filename
#define AWS_IOT_CERTIFICATE_FILENAME "5b8e8ee5cf-certificate.pem.crt"                 // your certificate filename
#define AWS_IOT_PRIVATE_KEY_FILENAME "5b8e8ee5cf-private.pem.key"              // your private key filename
//===============================================================
